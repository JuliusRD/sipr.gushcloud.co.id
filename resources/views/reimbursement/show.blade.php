...
@section('title')
    Show Reimbursement Request | SIPR
@endsection
@section('header')
                            ...
                            <table class="table table-vcenter card-table text-center">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td>{{ $reimbursement->leader->name ?? '-' }}<br><small><i>({{ $reimbursement->approval->approval_leader_status }})</i></small>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
        ...
        <div class="col-md-3 d-block">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    ...
                    @if ($reimbursement->approval->approval_leader_status != 'Tidak Disetujui')
                            ...
                            @if ($reimbursement->approval->approval_leader_status != 'Disetujui')
                                    ...
                                    <div>
                                        <form class="form-delete" onsubmit="return confirm('Konfirmasi hapus data ini?')"
                                            action="{{ route('reimbursement.destroy', $reimbursement->id) }}" method="POST">
                                            @csrf
                                            @method('DELETE')
