...
@section('title')
    Reimbursement Request Detail | SIPR
@endsection
@section('header')
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-7">: {{$reimbursement->divisi->nama ?? ''}}</div>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <form class="form-delete"
                                                    ...
                                                    @csrf
                                                    @method('DELETE')
                                                    <input type="hidden" name="url_back" value="{{ route('reimbursement.detail', $reimbursement->id) }}">
