            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    <span class="d-none d-sm-inline">
                        <a href="{{ route('historyreimbursement.index') }}" class="btn btn-white">
                            History
                        </a>
                    </span>
                    <a href="{{ route('reimbursement.create') }}" class="btn btn-primary d-none d-sm-inline-block">
                        ...
                        <tbody>
                            @forelse ($reimbursement as $key => $data)
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{ route('reimbursement.show', $data->id) }}" class="btn btn-primary btn-sm">
                                            Lihat Detail
                                        </a>
                                    </td>
                                </tr>
