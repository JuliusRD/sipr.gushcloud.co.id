                ...
                <ul class="nav nav-tabs " data-bs-toggle="tabs">
                    <li class="nav-item">
                        <a href="#tabs-home-17" class="nav-link active" data-bs-toggle="tab">
                            <h3 class="card-title text-dark my-2">Step 1: Purchase Request</h3>
                        </a>
                    </li>
                    <li class="nav-item">
                            ...
                            <form action="{{ route('purchase.update', $purchase->id) }}" method="POST">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        ...
                                        <select name="institusi_id" class="form-select" name="institusi_id" id="institusi_option" required>
                                            @forelse ($institusi as $id => $nama)
                                                <option value="{{ $id }}" {{$purchase->institusi_id == $id ? 'selected':''}}>{{ $nama }}</option>
                                            @empty
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        ...
                                        <select name="divisi_id" class="form-select" name="divisi_id" id="divisi_option" required>
                                            @forelse ($divisi as $id => $nama)
                                                <option value="{{ $id }}" {{$purchase->divisi_id == $id ? 'selected':''}}>{{ $nama }}</option>
                                            @empty
                                                <option disabled selected>Data not found</option>
                                            @endforelse
                                        </select>
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        ...
                                        <select name="leader_id" class="form-select" id="leader_option" required>
                                          @forelse ($leader as $id => $nama)
                                            <option value="{{ $id }}" {{$purchase->leader_id == $id ? 'selected':''}}>{{ $nama }}</option>
                                          @empty
                                              <option disabled selected>Data not found</option>
                                          @endforelse
                                        </select>
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        ...
                                        <select name="finance_id" class="form-select" id="finance_option" required>
                                            @forelse ($finance as $id => $nama)
                                                <option value="{{ $id }}" {{$purchase->finance_id == $id ? 'selected':''}}>{{ $nama }}</option>
                                            @empty
                                                <option disabled selected>Data not found</option>
                                            @endforelse
                                        </select>
                                    ...
                                    <div class="col-md-6 col-12 mb-3">
                                        ...
                                        <div class="input-icon">
                                            ...
                                            <input class="form-control" name="due_date" placeholder="Select a due date" id="due-date-picker"
                                    ...
                                    <div class="col-12 mb-3">
                                        ...
                                        placeholder="Harap masukkan link pembelian" required>{{$purchase->note ?? ''}}</textarea>
                                    </div>
                                    <div class="mb-3">
